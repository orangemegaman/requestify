import { Panel, PanelHeader, SplitCol, SplitLayout, View } from '@vkontakte/vkui';
...
export const App = () => {
	...
	return (
		<SplitLayout style={{ justifyContent: 'center' }} header={<PanelHeader separator={false} />} popout={popout}>
